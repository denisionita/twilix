                    ...
                    <div className="row align-items-center">
                        <div className="col-xl-4 col-lg-4 col-md-12">
                            <div className="tp-footer-widget tp-footer-col-1 pb-40 tp_fade_anim" data-delay=".3">
                                <h4 className="tp-footer-widget-title">Helping <br /> brands scale & grow.</h4>
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6">
                            <div className="tp-footer-widget tp-footer-col-3 pb-40 mb-30 tp_fade_anim" data-delay=".7">
                                ...
                                <div className="tp-footer-widget-info">
                                    <Link href="mailto:hello@twilix.agency">hello@twilix.agency</Link>
                                    <Link href="tel:+3025550107">0761 951 801</Link>
                                </div>
                                <div className="tp-footer-widget-info">
                                    <Link href="#" target="_blank">24 Peter St. Manchester, <br />
                                        UK, M23NG </Link>
                                </div>
                            </div>
                        </div>
