...
import about11 from '../../../public/assets/img/home-06/about/about-1.webp';
import about2 from '../../../public/assets/img/home-06/about/about-3.jpg';
import about22 from '../../../public/assets/img/home-06/about/about-2.webp';
import about3 from '../../../public/assets/img/home-06/about/about-2.jpg';
import about33 from '../../../public/assets/img/home-06/about/about-3.webp';
                    ...
                    <div className="row align-items-start">
                        <div className="col-xl-10">
                            <div className="studio-about-title-box mb-80">
                                ...
                                <h3 className="tp-section-title-clash tp-text-revel-anim"><span className="clash-subtitle-space-1">{`We're`}</span><br /> a creative marketing agency.</h3>
                            </div>
                        </div>
                        <div className="col-xl-2 d-none d-xl-block">
                            <div className="studio-about-thumb">
                                <Image style={{ width: "100%", height: "auto" }} data-speed=".8" src={about22} alt="about" />
                            </div>
                        </div>
                    </div>
                    <div className="row align-items-end">
                        <div className="col-xl-4 col-lg-6 col-md-6">
                            <div className="studio-about-thumb thumb-1">
                                <Image data-speed=".8" src={about11} alt="about" />
                            </div>
                        </div>
                        <div className="col-xl-4 col-lg-6 col-md-6">
                            <div className="studio-about-content tp_text_anim">
                                <p className="mb-30">
                                    We are a creative marketing agency helping brands grow through bold storytelling, digital campaigns, and design-driven strategies.
                                </p>
                                <p className="mb-40">
                                    As an award-winning agency, Twilix transcends aesthetics, crafting your vision into a legacy that endures.
                                </p>
                        ...
                        <div className="col-xl-4 col-lg-6 d-none d-xl-block">
                            <div className="studio-about-thumb text-end text-xxl-start">
                                <Image data-speed="1.1" src={about33} alt="about" />
                            </div>
                        </div>
                    </div>
                </div>
